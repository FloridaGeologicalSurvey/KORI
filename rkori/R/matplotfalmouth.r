...
#' @param point_size (numeric) A numeric value giving the point size for plots. Defaults to 1, bt may need adjusting depending on the size of the date range plotted.
