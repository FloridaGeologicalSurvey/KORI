...
CREATE OR REPLACE VIEW public.rgchn
    ...
    SELECT S.site_name, ghcn.date_time, ghcn.prcp as val, text 'precipitation' as var, text 'GHCN' as dataset FROM (extra.ghcn AS ghcn INNER JOIN extra.sites AS S USING (site_id)) UNION ALL
